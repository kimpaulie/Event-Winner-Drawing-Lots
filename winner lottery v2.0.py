...
#print(double_check)
winner_id=double_check.loc[double_check['추첨 번호'].isin(winner_result),['ID','추첨 번호']]

print(winner_id)
winner_id['당첨자 표시']='O'
df['당첨자 표시'] = winner_id['당첨자 표시']

print('\n당첨자를 파일 내 마지막 열 리스트에 표기하였습니다.')

df.to_excel("listfile.xlsx",'Sheet1', index=False, encoding='utf-8')
